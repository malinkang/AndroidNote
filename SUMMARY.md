...
* [系统源码分析](system/README.md)
  ...
  * [Android系统启动](system/android-xi-tong-qi-dong/README.md)
    ...
    * [Zygote进程启动流程](system/framework-zygote.md)
  ...
  * [四大组件的工作过程](system/si-da-zu-jian-de-gong-zuo-guo-cheng/README.md)
    ...
    * [Activity启动流程](system/start-activity.md)
  ...
  * [Binder原理](system/binder.md)
    * [Binder驱动](system/framework-binder-driver.md)
    * [获取ServiceManager](system/framework-get-sm.md)
    * [启动ServiceManager](system/framework-start-sm.md)
    * [Parcel源码分析](system/framework-parcel.md)
